    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="container py-10 flex-1">
        ...
        <div className="prose prose-gray dark:prose-invert max-w-none space-y-4">
          ...
          <p>
            Bo Nyambe ("we", "us", or "our") is committed to protecting your
            personal information. This Privacy Policy explains how we collect,
            use, and safeguard your data when you use our website or services.
          </p>
          ...
          <ul>
            <li>
              ...
              and message when you contact us.
            </li>
            <li>
              <strong>Appointment Form:</strong> Your name, email address, phone
              number, preferred date/time, and project description.
            </li>
            <li>
              <strong>Account Information:</strong> When you create an account,
              we store your email and profile details.
            </li>
            <li>
              <strong>Technical Data:</strong> IP address, browser type, and
              usage statistics for analytics purposes.
            </li>
          </ul>
          ...
          <p>
            ...
            by law. Contact form submissions are typically retained for 2 years.
          </p>
          ...
          <p>
            ...
            Cookies help us understand how visitors interact with our site. You
            may disable cookies in your browser settings, though this may affect
            site functionality.
          </p>
