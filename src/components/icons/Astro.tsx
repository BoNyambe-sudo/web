const Astro = ({ size = 64 }: { size?: number }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="none">
      ...
      <path
        fill="#17191e"
        d="M6.5 41.622s8.562-4.17 17.147-4.17l6.474-20.034c.242-.969.95-1.627 1.748-1.627.8 0 1.507.658 1.75 1.627l6.472 20.034c10.169 0 17.148 4.17 17.148 4.17L42.668 1.926C42.25.754 41.546 0 40.596 0H23.145c-.95 0-1.626.754-2.072 1.926C21.04 2.004 6.5 41.622 6.5 41.622"
